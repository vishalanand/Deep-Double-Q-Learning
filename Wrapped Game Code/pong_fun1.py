...
class GameState:
    ...
    def frame_step(self,input_vect1, input_vect2):
        ...
        if sum(input_vect1) != 1  or sum(input_vect2) != 1  :
            raise ValueError('Multiple input actions!')

        if input_vect1[1] ==1:#Key up
            self.bar1_move = -ai_speed
        elif input_vect1[2] == 1:#Key down
            self.bar1_move = ai_speed
        else: # don't move
            self.bar1_move = 0
        ...
        return image_data, reward1, reward2, terminal
